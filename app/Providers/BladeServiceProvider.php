    ...
    public function boot()
    {
        ...
        Blade::directive('alertSuccess', function (){
            $message = '<?php if(session(\'success\')){ ?>';
                $message.= '<div x-data="{ isHidden: false }">';
                    $message .= '<div class="sm:max-w-md mx-auto bg-green-100 text-green-900 border-green-200 border-2 shadow-md rounded px-2 py-2 flex justify-between items-center pl-6" :class="{\'hidden\': isHidden }">
        ...
        Blade::directive('alertError', function (){
            $message = '<?php if(session(\'error\')){ ?>';
                $message.= '<div x-data="{ isHidden: false }">';
                    $message .= '<div class="sm:max-w-md mx-auto bg-red-100 text-red-900 border-red-200 border-2 shadow-md rounded px-2 py-2 flex justify-between items-center pl-6" :class="{\'hidden\': isHidden }">
