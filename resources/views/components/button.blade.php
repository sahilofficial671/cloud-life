...
@php
    ...
    $class .= [
        ...
        'light-success'   => ' bg-green-200 border-green-300 border-opacity-60 hover:bg-green-300 text-green-600 ring-green-200 focus:border-green-300 active:bg-green-300',
    ][$buttonType];
