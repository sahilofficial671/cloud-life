                                ...
                                <div class="px-3 lg:px-6 py-4">
                                    <div class="flex justify-between items-start">
                                        <div class="left flex items-center">
                                            ...
                                            <div class="flex items-center justify-items-center bg-indigo-100 bg-opacity-25 p-1 rounded-full w-14 h-14 md:w-12 md:h-12 lg:w-16 lg:h-16 mr-2 border-2 border-indigo-100 border-opacity-50">
                                            ...
                                            <div class="details inline-flex flex-col items-start pt-1">
                                                ...
                                                <h4 class="text-lg lg:text-xl font-semibold">{{ __($vehicle->model) }}</h4>
                                        ...
                                        <div class="right flex flex-col justify-between">
                                            ...
                                            <div class="text-center">
                                                <form method="POST" action="{{route('vehicles.destroy', $vehicle)}}">
                                                    ...
                                                    <x-button buttonType="danger-light" height="h-7" type="submit"  x-bind:disabled="items.length == 0"  class="mt-5">
